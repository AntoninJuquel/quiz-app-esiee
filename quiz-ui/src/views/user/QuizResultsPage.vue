...
export default {
  ...
  methods: {
    copyToClipboard() {
      navigator.clipboard.writeText(this.score.toString())
    }
  }
}
</script>
...
<template>
  <v-sheet class="d-flex flex-column align-center justify-center flex-wrap text-center mx-auto mb-4" elevation="4"
    height="350" rounded max-width="800" width="100%">
